...
const LanguageSelectionDialog = ({
    ...
    const { availableLanguages, currentLanguage, setLanguage, filterLanguages } = initialData
    ...
    const { matchingLanguages, nonMatchingLanguages } = useMemo(() => {
        let languages = availableLanguages.filter(
            (language) => {
    ...
    return (
        <div className="zd:flex zd:flex-col zd:h-full zd:gap-4 zd:w-[90vw] zd:max-w-md">
            ...
            <div className="zd:flex-1 zd:overflow-y-auto zd:space-y-4">
                ...
                {/* No languages found */}
                {matchingLanguages.length === 0 && nonMatchingLanguages.length === 0 && (
